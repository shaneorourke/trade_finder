...
def dataframe():
    sql = f'SELECT symbol, screener, interval, status, rsi, stock_k, stock_d, macd, macd_signal, ema20, ema50, case when ema20 > ema50 then "UP" else "DOWN" end as Trend  FROM symbol_stats'
    ...
    col_list = ['symbol', 'screener', 'interval', 'status', 'Trend']
